## 🔗LangChain
Langchain is a javaScript library that allow to build LLM powered software.

## Topics
1. API call ( using any AI such as OpenAI, Claude, Groq (free) )
2. Build TOOLS for your first AI agent ( Tools - function that tells AI agent what to do )<br>
e.g:<br>
